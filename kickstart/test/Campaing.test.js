...
beforeEach(async () => {
    accounts = new web3.eth.getAccounts();
    ...
    //it'll come an array, so take the 1st element of that and assign to CampaignAddress
    [campaignAddress] = await factory.methods.getDeployedCampaigns().call();
    //once deployed I can store it in a variable to avoid new deployments
...
describe('Campaigns', () => {
    ...
    it('it allows people to contribute money and mark them as approvers', async () => {
